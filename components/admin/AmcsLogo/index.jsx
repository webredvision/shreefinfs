            ...
            <div className="flex gap-x-2">
              {packageData.map((item, index) => (
                <div className="mx-1" key={index}>
                  <Button
                    className="text-[var(--rv-white)] px-3 py-1 bg-[var(--rv-primary)] hover:bg-indigo-500 rounded"
                    ...
                    <div className="flex justify-end gap-3 mb-3">
                      <button
                        className={`flex justify-center rounded-[7px] px-3 py-[7px] font-medium ${item.status
                          ? "bg-green-500 text-[var(--rv-white)]"
                      ...
                      <button
                        className="flex justify-center rounded-[7px] border border-stroke px-3 py-[7px] font-medium text-dark hover:shadow-1 dark:border-dark-3 dark:text-[var(--rv-white)] hover:dark:text-red-500"
                        type="submit"
