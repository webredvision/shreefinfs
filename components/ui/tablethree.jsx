        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-[#F7F9FC] text-left dark:bg-dark-2">
              <th className="min-w-[220px] px-4 py-4 font-medium text-dark dark:text-[var(--rv-white)] xl:pl-7.5">
                Title
              </th>
              <th className="min-w-[150px] px-4 py-4 font-medium text-dark dark:text-[var(--rv-white)]">
                Created At
              </th>
              <th className="min-w-[120px] px-4 py-4 font-medium text-dark dark:text-[var(--rv-white)]">
                Updated At
              </th>
              <th className="px-4 py-4 text-right font-medium text-dark dark:text-[var(--rv-white)] xl:pr-7.5">
                Actions
              </th>
            </tr>
          </thead>
          <tbody>
            {packageData && packageData?.map((packageItem, index) => (
              <tr key={index}>
                ...
                >
                  <h5 className="text-dark dark:text-[var(--rv-white)]">
                    {packageItem.title}
                  </h5>
                </td>
                {/* <td
                ...
                >
                  <p className="text-dark dark:text-[var(--rv-white)]">
