...
const SipPerformanceTable = (prop) => {
    const data1 = prop.data.sipData;
    ...
    return (
        <div>
            <div className="w-full dark:text-[var(--rv-white)] dar:bg-[var(--rv-white)]">
                <div className="flex items-center py-4">
                    <Input
                        ...
                        className="max-w-sm dark:text-black"
                    />
                </div>
...
export default SipPerformanceTable;
